-- Garante que "VARIAS" nao sobrescreva uma unidade real ao propagar
-- unidade de item de emenda para ATA, itens e inventario.
...
comment on function public.editar_emenda_item_unidade_cascade(uuid, text, text)
  is 'Updates emenda item unit fields and propagates the real delivery/display unit to linked ATA executions, items, and inventory.';
